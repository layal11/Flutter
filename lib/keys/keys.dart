...
import 'package:first_flutter_app/keys/checkable_todo_item.dart';
import 'package:flutter/material.dart';

// import 'package:first_flutter_app/keys/todo_item.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  //--------KEY starts
                  //ValueKey use a single value instead of an entire object
                  key: ValueKey(todo.text),

                  //ObjectKey use the entire todo object
                  // key: ObjectKey(todo),
                  //KEY ends--------
